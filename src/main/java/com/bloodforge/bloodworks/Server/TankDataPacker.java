...
{
    public static CompoundTag getTankDataTagForSavingToMasterTag(String tankName)
    {
    ...
    public static TankDataContainer getTankDataFromCompound(String tankName, CompoundTag masterTag)
    {
        ...
        return new TankDataContainer(tankName, params, children, masterTag.getCompound("fluidTank"));
    }
