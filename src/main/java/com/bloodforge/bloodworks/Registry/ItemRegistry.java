...
import com.bloodforge.bloodworks.Items.BloodworksMusicDisc;
...
//    public static final RegistryObject<Item> BLOCK_NEURON                   = ITEMS.register("block_neuron", () -> new BlockItem(BlockRegistry.BLOCK_NEURON.get(), new Item.Properties().tab(CREATIVE_TAB)));
    ...
    public static final RegistryObject<Item> ITEM_RECORD_INDUSTRY = ITEMS.register("music_disc_industry", () ->
    {
        return new BloodworksMusicDisc(4, SoundRegistry.MUSIC_DISC_INDUSTRY, 2460);
    });
}