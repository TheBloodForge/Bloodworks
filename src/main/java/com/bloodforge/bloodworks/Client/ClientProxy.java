...
public class ClientProxy
{
    ...
    @Mod.EventBusSubscriber(modid = Globals.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
    public static class ClientForgeBus
    {
        ...
        public static void onClientChat(ClientChatEvent event)
        {
            ...
            //SAMReciter.Speak(new Vec3(-57, 80, 4), msg); //test code that makes Keldon go insane and turn into a mass of simulated sand particles
        }
    }
}