...
public record MultiBlockScanResult(boolean OK, @Nullable BlockPos errorLocation, @Nullable BlockMask expectedBlocks, @Nullable HashMap<Block, ArrayList<BlockPos>> specialBlocks)
{
    @Override
