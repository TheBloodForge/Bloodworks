package com.wiggle1000.bloodworks.Server.Menus;
...
{
    public final BE_InfusionChamber blockEntity;
    ...
    public InfusionChamberMenu(int id, Inventory inv, BlockEntity entity, ContainerData data)
    {
        super(MenuRegistry.INFUSION_CHAMBER.get(), id);
        this.blockEntity = (BE_InfusionChamber) entity;
        this.level = inv.player.level;
        this.data = data;
        this.fluidStack = blockEntity.getFluidInTank(0);
